...
class _HomeScreenState extends State<HomeScreen>
            ...
            child: Column(
              children: [
                ...
                Text(
                    ...
                    textAlign: TextAlign.center,
                    style:
                        TextStyle(fontSize: 13, color: subColor, height: 1.5)),
                ...
                Row(children: [
                  Expanded(child: _statCard('${state.articleCount}', 'Articles',
                      Icons.article_outlined,
                      bg: statBg, border: statBorder, iconColor: statIcon,
                      valueColor: statValue, labelColor: statLabel)),
                  const SizedBox(width: 8),
                  Expanded(child: _statCard('${state.userCount}', 'Contributors',
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(excerpt,
                        style: const TextStyle(
                            fontSize: 13, color: _inkLight, height: 1.6),
                        maxLines: 3,
                        overflow: TextOverflow.ellipsis),
                    const SizedBox(height: 14),
  ...
  Widget _featuredBadge() => Container(
        ...
        decoration: BoxDecoration(
            color: _sage, borderRadius: BorderRadius.circular(8)),
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border:
                      Border.all(color: const Color(0xFFFFD9A0))),
